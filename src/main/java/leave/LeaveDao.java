...
public class LeaveDao {
    public List<LeaveBean> allLeaves(String toDateS,String fromDateS){
        ...
        System.out.println(toDateS +"   = = = == " +fromDateS);
        ...
        try
        {
            ...
            System.out.println("SELECT * FROM `leavedetails` WHERE leaveFrom >= '"+fromDateS+"' and leaveTo <='"+toDateS+"' ORDER BY `leavedetails`.`appliedDate`  ASC");
             while (rs.next())
            {
    ...
    public List<LeaveBean> myLeaves(String empId,String toDateS,String fromDateS){
        ...
        try
        {
            ...
            System.out.println("SELECT * FROM `leavedetails` WHERE leaveFrom >= '"+fromDateS+"' and leaveTo <= '"+toDateS+"' and empId="+empId+" ORDER BY `leavedetails`.`appliedDate` ASC");
            while (rs1.next())
            {
                LeaveBean leave = new LeaveBean();
