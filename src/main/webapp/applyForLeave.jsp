        ...
        <div class="main">
            <table>
                ...
                <tr>
                    ...
                    <th>
                        <input class="input" type="date" name="appliedDate" id="applied">
                    </th>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <th>
                        <input class="input" type="text" name="senderId" id="empId"  placeholder="Select Sender for this Request From the given List" READONLY>
                    </th>
                </tr>
    ...
    <div class="result">
        ...
        <table id="tableResult">
            ...
            <tr>
                ...
                <td class="empName"><%=leave.getFName()%> <%=leave.getLName()%></td>
