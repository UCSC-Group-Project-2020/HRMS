...
<div class="content">
    ...
    <table>
        <tr>
            ...
            <th>
                <input class="input" type="text" name="empid">
            </th>
    ...
    <div class="userPre">
        ...
        <table>
            <tr>
                ...
                <th></th>
                <th>
                    <a href="#" class="Register">Register &raquo;</a>
                </th>
            </tr>
        </table>
    </div>
...
<div class="form-popup" id="myForm">
    <form action="/action_page.php" class="form-container">
        <br>
        <input class="input" type="text" placeholder="Put Your Finger to the Scanner" name="fingerprint" readonly>
        <br>
        <img class="wave" src="img/123.gif" onclick="NextForm()">
        br
        <button type="button" class="btnnext" onclick="NextForm()">Next</button>
...
<div class="form-popup" id="myForm2">
    <form action="/action_page.php" class="form-container">
        <br>
        <input class="input" type="text" placeholder="Put Your Finger Again To Confirm" name="fingerprint" readonly>
        <br>
        <img class="wave" src="img/123.gif" onclick="closeForm()">
        <br>
